...
class Game(PygameGame):
    ...
    def gameScreen(self):
        self.gameBackground = pygame.image.load('D:\game\sky.jpg').convert_alpha()
        ...
        self.gameBackground = pygame.transform.scale(self.gameBackground,
                        (int(gameBackgroundW*3.2), int(gameBackgroundH*2.4)))
        self.car = pygame.image.load('D:\game\car2.gif').convert_alpha()
...
class FuelGauge(Game):
    ...
    def __init__(self,x,y):
        ...
        self.height=12
        self.width=200
        self.fuel =pygame.image.load('D:/game/gasoline.png').convert_alpha()
...
class Coins(Game):
    def __init__(self,x,y):
        self.x=x
        self.y=y
        self.coin = pygame.image.load('D:/game/coin.jpg').convert_alpha()
...
class FuelTank(Game):
    def __init__(self,x,y):
        self.x=x
        self.fuel = pygame.image.load('D:/game/gasoline.jpg').convert_alpha()
        self.w,self.h = self.fuel.get_size()
        self.w*=.3
        self.h*=.3
        self.y=y-self.h
...
class Boulder(Game):
    def __init__(self,x,y):
        self.x=x
        self.y=y
        self.boulder = pygame.image.load('D:/game/boulder.jpg').convert_alpha()
